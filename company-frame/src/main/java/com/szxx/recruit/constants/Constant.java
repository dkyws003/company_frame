package com.szxx.recruit.constants;

/**
 * @ClassName: Constant
 * TODO:类文件简单描述
 * @Author: yws
 * @CreateDate: 2020/9/6 23:30
 * @UpdateUser: yws
 * @UpdateDate: 2020/9/6 23:30
 * @Version: 0.0.1
 */
public class Constant {
     ...
     * 用户权鉴缓存 key
     */
    public static final String IDENTIFY_CACHE_KEY="shiro-cache:com.szxx.recruit.shiro.CustomRealm.authorizationCache:";
   ...
   * */
    ...
    public static final String SEND_RECRUIT_REQUEST="http://10.0.196.190:8000/entry/sendRecruitRequest";
    ...
    public static final String UPLOAD_ZIP_FILE="http://10.0.196.190:8000/entry/uploadZipFile";
    /*
     * 远程请求地址 发送招聘需求
     *
     * */

    public static final String ADD_CANDIDATE_INFO="http://10.0.196.190:8000/entry/addCandidateInfo";
