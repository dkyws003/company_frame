 ...
 * TODO:类文件简单描述
 * @Author: yws
 * @CreateDate: 2020/9/6 23:49
 * @UpdateUser: yws
 * @UpdateDate: 2020/9/6 23:49
 * @Version: 0.0.1
 */
@Slf4j
public class JwtTokenUtil {
     ...
     * 生成 access_token
     * @Author:      yws
     * @CreateDate:  2020/9/26 10:22
     * @UpdateUser:
     * @UpdateDate:  2020/9/26 10:22
     * @Version:     0.0.1
     * @param subject
     * @param claims
     ...
     * @Author:      yws
     * @CreateDate:  2020/9/26 10:24
     * @UpdateUser:
     * @UpdateDate:  2020/9/26 10:24
     * @Version:     0.0.1
     * @param subject
     * @param claims
     * @return       java.lang.String
     ...
     * 签发token
     * @Author:      yws
     * @CreateDate:  2020/9/7 20:42
     * @UpdateUser:
     * @UpdateDate:  2020/9/7 20:42
     * @Version:     0.0.1
     * @param issuer 签发人
     ...
     * 获取用户id
     * @Author:      yws
     * @CreateDate:  2020/9/7 17:29
     * @UpdateUser:
     * @UpdateDate:  2020/9/7 17:29
     * @Version:     0.0.1
     * @param token
     * @return       java.lang.String
     * @throws
     ...
     * 获取用户名
     * @Author:      yws
     * @CreateDate:  2020/9/23 15:39
     * @UpdateUser:
     * @UpdateDate:  2020/9/23 15:39
     * @Version:     0.0.1
     * @param token
     * @return       java.lang.String
     * @throws
     ...
     * 从令牌中获取数据声明
     * @Author:      yws
     * @CreateDate:  2020/9/7 21:21
     * @UpdateUser:
     * @UpdateDate:  2020/9/7 21:21
     * @Version:     0.0.1
     * @param token
     ...
     * 校验令牌
     * @Author:      yws
     * @CreateDate:  2020/9/7 22:15
     * @UpdateUser:
     * @UpdateDate:  2020/9/7 22:15
     * @Version:     0.0.1
     * @param token
     ...
     * 验证token 是否过期
     * @Author:      yws
     * @CreateDate:  2020/9/7 21:27
     * @UpdateUser:
     * @UpdateDate:  2020/9/7 21:27
     * @Version:     0.0.1
     * @param token
     * @param secretKey
     * @return       java.lang.Boolean
     ...
     * 刷新token
     * @Author:      yws
     * @CreateDate:  2020/9/7 22:14
     * @UpdateUser:
     * @UpdateDate:  2020/9/7 22:14
     * @Version:     0.0.1
     * @param refreshToken
     ...
     * 获取token的剩余过期时间
     * @Author:      yws
     * @CreateDate:  2020/9/7 22:19
     * @UpdateUser:
     * @UpdateDate:  2020/9/7 22:19
     * @Version:     0.0.1
     * @param token
     * @param secretKey
     * @return       long
