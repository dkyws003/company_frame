...
import com.szxx.recruit.mapper.SysPermissionMapper;
...
public class PermissionServiceImpl implements PermissionService {
     ...
     * 也可以多表关联查询
     * @Author:      yws
     * @CreateDate:  2020/9/20 11:42
     * @UpdateUser:
     * @UpdateDate:  2020/9/20 11:42
     * @Version:     0.0.1
     * @param userId
     * @return       java.util.List<com.szxx.recruit.entity.SysPermission>
     * @throws
     */
    @Override
     ...
     * 新增菜单权限
     * @Author:      yws
     * @CreateDate:  2020/9/20 12:24
     * @UpdateUser:
     * @UpdateDate:  2020/9/20 12:24
     * @Version:     0.0.1
     * @param vo
     * @return       com.szxx.recruit.entity.SysPermission
     * @throws
     */
    @Override
     ...
     * 编辑或者新增的时候检验
     * @Author:      yws
     * @CreateDate:  2020/10/31 21:22
     * @UpdateUser:
     * @UpdateDate:  2020/10/31 21:22
     * @Version:     0.0.1
     * @param sysPermission
     * @return       void
     * @throws
     ...
     * 查询菜单权限详情
     * @Author:      yws
     * @CreateDate:  2020/9/20 14:05
     * @UpdateUser:
     * @UpdateDate:  2020/9/20 14:05
     * @Version:     0.0.1
     * @param permissionId
     * @return       com.szxx.recruit.entity.SysPermission
     * @throws
     ...
     * 更新菜单权限
     * @Author:      yws
     * @CreateDate:  2020/9/20 14:04
     * @UpdateUser:
     * @UpdateDate:  2020/9/20 14:04
     * @Version:     0.0.1
     * @param vo
     * @return       void
     * @throws
     ...
     * 分页获取所有菜单权限
     * @Author:      yws
     * @CreateDate:  2020/9/20 14:03
     * @UpdateUser:
     * @UpdateDate:  2020/9/20 14:03
     * @Version:     0.0.1
     * @param vo
     * @return       com.szxx.recruit.vo.resp.PageVO<com.szxx.recruit.entity.SysPermission>
     * @throws
     */
    @Override
     ...
     * 获取权限标识
     * @Author:      yws
     * @CreateDate:  2020/9/20 23:13
     * @UpdateUser:
     * @UpdateDate:  2020/9/20 23:13
     * @Version:     0.0.1
     * @param userId
     ...
     * @Author:      yws
     * @CreateDate:  2020/9/23 10:53
     * @UpdateUser:
     * @UpdateDate:  2020/9/23 10:53
     * @Version:     0.0.1
     * @param userId
     * @return       java.util.List<com.szxx.recruit.vo.resp.PermissionRespNode>
     * @throws
     */
    @Override
     ...
     * 递归获取菜单树
     * @Author:      yws
     * @CreateDate:  2020/10/27 18:27
     * @UpdateUser:
     * @UpdateDate:  2020/10/27 18:27
     * @Version:     0.0.1
     * @param all
     ...
     * 递归遍历所有
     * @Author:      yws
     * @CreateDate:  2020/10/25 16:51
     * @UpdateUser:
     * @UpdateDate:  2020/10/25 16:51
     * @Version:     0.0.1
     * @param id
     * @param all
     * @return       java.util.List<com.szxx.recruit.vo.resp.PermissionRespNode>
     ...
     * 获取所有菜单权限按钮
     * @Author:      yws
     * @CreateDate:  2020/10/27 18:29
     * @UpdateUser:
     * @UpdateDate:  2020/10/27 18:29
     * @Version:     0.0.1
     * @param
     * @return       java.util.List<com.szxx.recruit.vo.resp.PermissionRespNode>
     * @throws
     ...
     * 选择自己和它的子类
     * @Author:      yws
     * @CreateDate:  2020/10/31 13:08
     * @UpdateUser:
     * @UpdateDate:  2020/10/31 13:08
     * @Version:     0.0.1
     * @param
     * @return       java.util.List<com.szxx.recruit.vo.resp.PermissionRespNode>
     * @throws
